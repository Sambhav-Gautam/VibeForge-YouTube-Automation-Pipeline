...
downloads_dir = os.path.join(root_dir, "ChatBotAutomation", "gemini-downloader", "downloads_brainrot_memes")
music_dir = os.path.join(root_dir, "youtube_music")
output_dir = os.path.join(root_dir, "brainRotMemes_automation")
