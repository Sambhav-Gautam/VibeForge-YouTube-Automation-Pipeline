...
downloads_dir = os.path.join(root_dir, "ChatBotAutomation", "gemini-downloader", "downloads_illusions")
music_dir = os.path.join(root_dir, "youtube_music")
output_dir = os.path.join(root_dir, "illusions_automation")
...
# This script processes images from the illusions directory, applies audio from the music directory,
# and exports them as short videos in the illusions_automation directory.