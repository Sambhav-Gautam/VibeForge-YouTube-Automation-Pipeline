...
# Dynamically resolve the generated_shorts folder relative to this script
VIDEO_DIR = os.path.join(os.path.dirname(__file__), "generated_shorts")
...
def upload_video(youtube):
    ...
    title = pick_random_line(os.path.join(os.path.dirname(__file__), "titles.txt"))
    desc = pick_random_line(os.path.join(os.path.dirname(__file__), "descriptions.txt"))
